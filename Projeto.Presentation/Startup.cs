        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "API para Inclusão de Beneficiários",
                        Version = "v1",
                        Description = "Projeto desenvolvido em NET CORE 3.1 API usando o padrão DDD (Domain Driven Design)",
                        Contact = new OpenApiContact
                        {
                            Name = "Felipe Sampaio - Pipo Saúde",
